...
export type BICAdapter = Adapter & {
    getAccountByProviderAndUserId({ provider, userId }: {
        provider: string;
        userId: string;
    }): Awaitable<AdapterAccount | null>;
};
export declare function DynamoDBAdapter(client: DynamoDBDocument, options?: DynamoDBAdapterOptions): BICAdapter;
